...
# mamba create -n sttre python=3.12 pytorch torchvision torchaudio pytorch-cuda=12.4 lightning tensorboard numpy polars seaborn -c pytorch -c nvidia -c conda-forge
